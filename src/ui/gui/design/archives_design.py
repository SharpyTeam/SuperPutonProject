...
# Form implementation generated from reading ui file 'D:\Documents\Projects\HSE\SuperPutonProject\ui_src\archives.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dl_pb_label = QtWidgets.QLabel(self.centralwidget)
        self.dl_pb_label.setObjectName("dl_pb_label")
        self.verticalLayout.addWidget(self.dl_pb_label)
        self.dlProgressBar = QtWidgets.QProgressBar(self.centralwidget)
        self.dlProgressBar.setProperty("value", 31)
        self.dlProgressBar.setTextVisible(True)
        self.dlProgressBar.setInvertedAppearance(False)
        self.dlProgressBar.setObjectName("dlProgressBar")
        self.verticalLayout.addWidget(self.dlProgressBar)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.dl_pb_label.setText(_translate("MainWindow", "Скачивание данных:"))
        self.dlProgressBar.setFormat(_translate("MainWindow", "%p% (загружено %v из %m)"))
